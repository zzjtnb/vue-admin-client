  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container" trigger="click">
        <el-tooltip :content="info.nickname" placement="left" v-if="info.nickname">
        ...
        <el-dropdown-menu slot="dropdown" class="user-dropdown">
          ...
          <el-dropdown-item>
            <el-button type="text" @click="centerDialogVisible = true" style="color:#909399">修改密码</el-button>
          </el-dropdown-item>
